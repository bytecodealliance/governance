...
This document is a proposal to create $PROJECT_NAME as a formal Hosted Project under the auspices of the TSC of the Bytecode Alliance, as specified in the TSC’s charter.

Proposing the adoption of TODO as a Bytecode Alliance hosted project.

Current Repository URL: TODO (for existing projects being proposed for adoption)

Proposed Repository URL: TODO (URL of the repository to be created within the Bytecode Alliance GitHub organization)
